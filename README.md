...
```
chmod +x lvm
lvm vgscan --mknodes # Show and permit use of Volume Group using LVM2 ("droidian" for Droidian installation)
lvm vgchange -aly # Show the number (and permit use) of Logical Volumes (3 for Droidian)
```
